...
type Message interface {
	...
	//
	// The `channel_id` field contains the
	ChannelID() dlib.Snowflake

	// SetChannelID overwrites the current value of this record's `channel_id` field.
	...
	// GuildIDIsSet returns whether this record's `guild_id` field is currently present.
	GuildIDIsSet() bool
	...
	// MemberIsSet returns whether this record's `member` field is currently present.
	MemberIsSet() bool
	...
	//
	// The `content` field contains the
	Content() string
	...
	//
	// The `timestamp` field contains the
	Timestamp() time.Time

	// SetTimestamp overwrites the current value of this record's `timestamp` field.
	SetTimestamp(time.Time) Message

	// EditedTimestamp returns the current value of this record's `edited_timestamp` field.
	//
	// The `edited_timestamp` field contains the
	//
	...
	// EditedTimestampIsNull returns whether this record's `edited_timestamp` field is currently null.
	EditedTimestampIsNull() bool

	// SetEditedTimestamp overwrites the current value of this record's `edited_timestamp` field.
	SetEditedTimestamp(time.Time) Message

	// SetNullEditedTimestamp overwrites the current value of this record's `edited_timestamp` field
	// with `null`.
	SetNullEditedTimestamp() Message

	// TTS returns the current value of this record's `tts` field.
	//
	// The `tts` field indicates
	TTS() bool

	// SetTTS overwrites the current value of this record's `tts` field.
	SetTTS(bool) Message

	// MentionEveryone returns the current value of this record's `mention_everyone` field.
	//
	// The `mention_everyone` field indicates
	MentionEveryone() bool

	// SetMentionEveryone overwrites the current value of this record's `mention_everyone` field.
	...
	// MentionRoles returns the current value of this record's `mention_roles` field.
	//
	// The `mention_roles` field contains the
	MentionRoles() []comm.Role

	// SetMentionRoles overwrites the current value of this record's `mention_roles` field.
	SetMentionRoles([]comm.Role) Message

	// MentionChannels returns the current value of this record's `mention_channels` field.
	//
	...
	// MentionChannelsIsSet returns whether this record's `mention_channels` field is currently present.
	MentionChannelsIsSet() bool

	// SetMentionChannels overwrites the current value of this record's `mention_channels` field.
	...
	//
	// The `attachments` field contains the
	Attachments() []message.Attachment

	// SetAttachments overwrites the current value of this record's `attachments` field.
	SetAttachments([]message.Attachment) Message

	// Embeds returns the current value of this record's `embeds` field.
	//
	// The `embeds` field contains the
	...
	//
	// The `reactions` field contains the
	//
	// If this method is called on a field that is unset, this method will panic.
	// Use ReactionsIsSet to check if the field is present before use.
	Reactions() []message.Reaction

	// ReactionsIsSet returns whether this record's `reactions` field is currently present.
	ReactionsIsSet() bool

	// SetReactions overwrites the current value of this record's `reactions` field.
	SetReactions([]message.Reaction) Message
	...
	//
	// The `webhook_id` field contains the
	//
	// If this method is called on a field that is unset, this method will panic.
	// Use WebhookIDIsSet to check if the field is present before use.
	WebhookID() dlib.Snowflake

	// WebhookIDIsSet returns whether this record's `webhook_id` field is currently present.
	WebhookIDIsSet() bool

	// SetWebhookID overwrites the current value of this record's `webhook_id` field.
	...
	//
	// The `activity` field contains the
	//
	// If this method is called on a field that is unset, this method will panic.
	// Use ActivityIsSet to check if the field is present before use.
	Activity() message.Activity

	// ActivityIsSet returns whether this record's `activity` field is currently present.
	ActivityIsSet() bool
	...
	//
	// The `application` field contains the
	//
	// If this method is called on a field that is unset, this method will panic.
	// Use ApplicationIsSet to check if the field is present before use.
	Application() message.Application

	// ApplicationIsSet returns whether this record's `application` field is currently present.
	ApplicationIsSet() bool

	// SetApplication overwrites the current value of this record's `application` field.
	...
	// MessageReference returns the current value of this record's `message_reference` field.
	//
	// The `message_reference` field contains the
	//
	// If this method is called on a field that is unset, this method will panic.
	// Use MessageReferenceIsSet to check if the field is present before use.
	MessageReference() message.Reference

	// MessageReferenceIsSet returns whether this record's `message_reference` field is currently present.
	MessageReferenceIsSet() bool

	// SetMessageReference overwrites the current value of this record's `message_reference` field.
